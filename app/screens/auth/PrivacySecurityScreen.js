...
function PrivacySecurityScreen() {
  return (
    <Screen style={styles.screen} paddingSize="lg">
      ...
      <Text style={styles.subtitle}>Review account safety, privacy preferences, and security settings.</Text>
      ...
      <View style={styles.card}>
        <View style={styles.row}>
          ...
          <View style={styles.textWrap}>
            ...
            <Text style={styles.rowSubTitle}>Keep your account secure</Text>
          </View>
        </View>
        <View style={styles.row}>
          <View style={styles.iconWrap}>
          ...
          <View style={styles.textWrap}>
            ...
            <Text style={styles.rowSubTitle}>Control what others can see</Text>
          </View>
        </View>
      </View>
    </Screen>
